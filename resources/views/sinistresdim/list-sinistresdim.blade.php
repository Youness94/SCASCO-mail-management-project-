            ...
            <div class=" row group-form d-flex justify-content-end ">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-4">
                        ...
                        <a href="/reset-sinistre-dim" class="btn btn-outline-warning">Réinitialiser</a>
                    </div>
                        ...
                        <div class="page-header">
                            <div class="row align-items-center">
                                ...
                                <div class="col-auto text-end float-end ms-auto download-grp">
                                    ...
                                    <a href="{{ route('export.filtered.sinistres.dim', ['date_debut' => $date_debut, 'date_fin' => $date_fin]) }}" class="btn btn-outline-primary me-2"><i class="fas fa-download"></i> Télécharger</a> @endif

                                    <a href="{{ route('add.sinistre.dim') }}" class="btn btn-primary"><i class="fas fa-plus"></i></a>
                                </div>
                            </div>
                        </div>
                            ...
                            <table class="table border-0  table-center mb-0 datatable table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('show.sinistre.dim',$item->id)}}" class=" btn btn-inverse-danger"><i class="feather-eye"></i></a>
                                        </td>
                                        <td>
                                            <a href="{{route('edit.sinistre.dim',$item->id)}}" class="btn btn-inverse-warning"><i class="feather-edit"></i></a>
                                        </td>
                                        <td>
                                            <a href="{{route('delete.sinistre.dim',$item->id)}}" class=" btn btn-inverse-danger"><i class="feather-trash"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
