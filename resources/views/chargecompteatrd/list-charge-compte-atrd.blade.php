                        ...
                        <div class="page-header">
                            <div class="row align-items-center">
                                ...
                                <div class="col-auto text-end float-end ms-auto download-grp">
                                    ...
                                    <a href="{{ route('add.charge.compte.sinistre') }}" class="btn btn-primary"><i class="fas fa-plus"></i></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <table class="table border-0 star-student table-hover table-center mb-0 datatable table-striped">
                            ...
                            @foreach ($charge_compte_sinistres_at_rd as $key => $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('delete.charge.compte.sinistre',$item->id)}}"  class="btn btn-inverse-danger"><i class="feather-trash"></i></a>
                                    </td>
